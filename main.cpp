...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    float dm = 0; //natural death rate of melanophores
    float sm = 1; //killing of xanthophores by melanophores
    float sx = 1; //killing of melanophores by xanthophores
    float dl = 9; //death of melanophores with non-xanthophores h distance away
    ...
    //Ablation Parameters  
    int ablateWhen1000 = 500; //Change this value for when you want the simulation to ablate
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for (unsigned long long int iter = 0; iter < fullSteps; ++iter) {
        ...
        if (zebra.checkExist(i, j) == true) {
            if (proc < dl_p) { //death of melanophores with non xanthophores h distance away
            ...
            else if ((proc < dl_p + sm_p) && (proc >= dl_p)) { //Tests to see if local melanophore will kill xanthophore
            ...
            else if ((proc < dl_p + sm_p + sx_p) && (proc >= dl_p + sm_p)) { //Tests to see if local xanthophore will kill melanophore
                if (zebra.array[i][j] == 2) {
                    switch(rand() % 4) {
                        case 0: { //Above Neighbor
                            if ((up.array[i][j] != SHRT_MAX) && (up.checkExist(i, j) == true)) {
            ...
            else if ((proc < dl_p + sm_p + sx_p + bx_p) && (proc >= dl_p + sm_p + sx_p)) { //Tests for birth of xanthophore
            ...
            else if ((proc < dl_p + sm_p + sx_p + bx_p + bm_p) && (proc >= dl_p + sm_p + sx_p + bx_p)) { //Tests for birth of melanophore
            ...
            else if ((proc < dl_p + sm_p + sx_p + bx_p + bm_p + dx_p) && (proc >= dl_p + sm_p + sx_p + bx_p + bm_p)) { //Tests for death of xanthophore
                if (zebra.array[i][j] == 1) {
                    zebra.array[i][j] = 0;
                    hitCounter = hitCounter + 1;
                }
            ...
            else if ((proc < dl_p + sm_p + sx_p + bx_p + bm_p + dx_p + dm_p) && (proc >= dl_p + sm_p + sx_p + bx_p + bm_p + dx_p)) { //Tests for death of melanophore
                if (zebra.array[i][j] == 2) {
                    zebra.array[i][j] = 0;
                    hitCounter = hitCounter + 1;
                }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    csvfile << to_string(bx) << "," << to_string(bm) << "," << to_string(dx) << "," << to_string(dm) << "," << to_string(dl) << "," ;
